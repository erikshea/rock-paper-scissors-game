...
public class RPSGameTest extends RPSGame {
	...
	public void getOutcomeForHands_shouldGiveCorrectOutcomeAndUpdateScores() {
		...
		assertEquals("Gagné",player1.getOutcomeForHands(player2, 1,3));
		assertEquals("Gagné",player1.getOutcomeForHands(player2, 2,1));
		assertEquals("Gagné",player1.getOutcomeForHands(player2, 3,2));
